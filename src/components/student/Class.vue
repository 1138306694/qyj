  ...
  <div>
    <div>
      <el-breadcrumb separator="/" class="breadcrumb">
        ...
        <el-breadcrumb-item :to="{path:'/'}">正选</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div style="margin-left: 100px;margin-top: 50px">
      <div style="margin-left: 50px; width: 80%">
        <el-form ref="searchForm" :inline="true" :rules="rules" :model="searchFrom">
          ...
          <el-form-item style="margin-left: 25px">
            <el-button type="primary" plain @click="getPickResult">正选结果</el-button>
          </el-form-item>
        </el-form>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button ref="btn"  type="primary" size="mini" plain @click="choiceClass(scope.row)">选择</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
